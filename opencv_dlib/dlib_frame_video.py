...
cap = cv.VideoCapture('Image/test_1.mp4')
...
out = cv.VideoWriter('output_1.avi', fourcc, 30.0, (int(width), int(height)))
...
while cap.isOpened():
    ...
    if (ret is True) and (current_time > 1./ FPS) :
        ...
        for face in dets:
            ...
            nose_x.append(list_points[30][0])
            nose_y.append(list_points[30][1])
...
cap.release()
out.release()
plt.plot(nose_x, nose_y)	# line 그래프를 그립니다
plt.show()
